...
// dragging needs real geometry (getBoundingClientRect, pointer capture) that jsdom doesn't provide;
// that path is covered by tests/e2e/side-panel-layout.e2e.ts against a real browser instead.
import { describe, it, expect, vi, afterEach } from 'vitest';
import { render, screen, fireEvent, cleanup } from '@testing-library/react';
import {
  WorkspaceSplitter, STEP, type WorkspaceSplitterProps,
...
function renderSplitter(overrides: Partial<WorkspaceSplitterProps> = {}) {
  ...
  return { onWidthChange, onCollapse, onResetDefault };
}
