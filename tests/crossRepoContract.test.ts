...
// tripwire: it imports the real loreweaver's own constants from the sibling checkout (the same
// ~/Dev/personal layout every other integration test and the e2e configs already rely on) and
